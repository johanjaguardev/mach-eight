...
The projects was configured to read the data.txt file and make the exercise for each row in the file,
for start simply run "npm start", the project will start with the previous generated data.

If you want to generate another data you can run "npm run mock" and then a new data.txt file will be generated

After the execution you can find more details of the project in extended-results.txt files.
